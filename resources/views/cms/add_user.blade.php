...
<div class="col-md-8">
    <form action="{{ url('cms/users') }}" method="POST" enctype=multipart/form-data novalidate="novalidate">
        ...
        <div class="form-group">
            ...
            <input value="{{ old('address') }}" type="text" name="address" class="form-control" id="address" placeholder="Address">
        ...
        <button type="submit" name="submit" class="btn btn-success"><i class="mdi mdi-content-save"></i> Save user</button>
